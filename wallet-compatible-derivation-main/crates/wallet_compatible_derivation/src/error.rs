...
pub enum Error {
    ...
    #[error("Invalid BIP-32 HD path: '{0}'")]
    InvalidBIP32Path(String),

    #[error("Invalid Radix Account path (but valid BIP-32): '{0}'")]
    ...
    #[error("Invalid BIP-32 Path, expected: {expected}, found {found}.")]
    ...
    #[error("Failed to generate random entropy for mnemonic")]
