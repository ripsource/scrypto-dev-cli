...
import { PollTransactionStatusOptions } from '../transactionStatus/pollTransactionStatus';
export declare class TransactionService {
     ...
     */
    pollTransactionStatus(transactionId: string, options?: Omit<PollTransactionStatusOptions, 'gatewayApiClient'>): Promise<TransactionStatusResponse>;
}
