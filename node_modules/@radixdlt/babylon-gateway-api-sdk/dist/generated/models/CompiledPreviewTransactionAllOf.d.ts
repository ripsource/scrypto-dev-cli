 ...
 * @export
 */
export declare const CompiledPreviewTransactionAllOfTypeEnum: {
 ...
 */
export declare function instanceOfCompiledPreviewTransactionAllOf(value: object): boolean;
export declare function CompiledPreviewTransactionAllOfFromJSON(json: any): CompiledPreviewTransactionAllOf;
export declare function CompiledPreviewTransactionAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompiledPreviewTransactionAllOf;
export declare function CompiledPreviewTransactionAllOfToJSON(value?: CompiledPreviewTransactionAllOf | null): any;
