 ...
 * @export
 * @interface TransactionPreviewV2OptIns
 */
export interface TransactionPreviewV2OptIns {
    /**
...
the response.
     ...
     * @type {boolean}
     * @memberof TransactionPreviewV2OptIns
     */
...
/**
 * Check if a given object implements the TransactionPreviewV2OptIns interface.
 */
export declare function instanceOfTransactionPreviewV2OptIns(value: object): boolean;
export declare function TransactionPreviewV2OptInsFromJSON(json: any): TransactionPreviewV2OptIns;
export declare function TransactionPreviewV2OptInsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionPreviewV2OptIns;
export declare function TransactionPreviewV2OptInsToJSON(value?: TransactionPreviewV2OptIns | null): any;
