 ...
 * @export
 */
export declare const CompiledPreviewTransactionTypeEnum: {
 ...
 */
export declare function instanceOfCompiledPreviewTransaction(value: object): boolean;
export declare function CompiledPreviewTransactionFromJSON(json: any): CompiledPreviewTransaction;
export declare function CompiledPreviewTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompiledPreviewTransaction;
export declare function CompiledPreviewTransactionToJSON(value?: CompiledPreviewTransaction | null): any;
