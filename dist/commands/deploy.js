...
async function findWasmAndRpd() {
    ...
    if (!fs.existsSync(targetDir)) {
        console.error("❌ Target directory not found. Make sure you're in a Scrypto project directory.");
    ...
    if (!wasmFile || !rpdFile) {
        console.error("❌ Required files not found in target/wasm32-unknown-unknown/release/");
