...
function listAddress() {
    ...
    if (accounts.length === 0) {
        ...
        console.log('💡 Use "scrypto-dev import-address <mnemonic>" to import an existing account.');
        return;
    }
    ...
    if (activeAccount && activeAccount.network === network) {
        ...
        console.log('💡 Use "scrypto-dev set-address <account-id>" to set an active account.');
    }
}
//# sourceMappingURL=list-address.js.map