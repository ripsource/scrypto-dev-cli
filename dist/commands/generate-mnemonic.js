...
exports.generateMnemonicCommand = generateMnemonicCommand;
const rust_cli_1 = require("../utils/rust-cli");
const environment_1 = require("../utils/environment");
async function generateMnemonicCommand(options) {
    ...
    try {
        ...
        console.error("❌ Failed to generate mnemonic:", error instanceof Error ? error.message : error);
    }
}
//# sourceMappingURL=generate-mnemonic.js.map